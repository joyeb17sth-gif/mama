          ...
          <table className="w-full text-xs border-collapse min-w-[500px]">
            ...
            <tbody>
              ...
              <tr className="bg-violet-50/30">
                <td className="px-4 py-2 font-bold text-violet-700 text-[11px] uppercase tracking-widest border-b border-violet-100">
                  <div className="flex items-center justify-between">
                    <span>Income</span>
                    {isEditMode && (
                      <button
                        onClick={() => setShowAddItemModal({ show: true, type: 'income' })}
                        className="px-2 py-0.5 text-[10px] font-semibold text-violet-700 hover:bg-white/50 rounded transition-colors"
                      >
                        + Add Item
                      </button>
                    )}
              ...
              {(currentPeriod.incomeRows || []).map(row => {
                ...
                return (
                  <tr key={`inc-${row.key}`} className="hover:bg-violet-50/10 transition-colors group">
